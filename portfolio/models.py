...
class programa(models.Model):
  ...
  tecnologias_icono = models.TextField(null=True, blank=True)
  ...
  galeria_1 = models.TextField(null=True,blank=True)
  galeria_2 = models.TextField(null=True,blank=True)
  galeria_3 = models.TextField(null=True,blank=True)
  galeria_4 = models.TextField(null=True,blank=True)
  galeria_5 = models.TextField(null=True,blank=True)
  galeria_6 = models.TextField(null=True,blank=True)
